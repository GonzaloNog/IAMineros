...
public class TestPowerful : MonoBehaviour
{
    ...
    private void Start()
    {
        //grid = new Grid<HeatMapGridObject>(20, 10, 8f, this.transform.position, (Grid<HeatMapGridObject> g, int x, int y) => new HeatMapGridObject(g, x, y));
        //boolGrid = new Grid<bool>(20, 10, 8f, Vector3.zero, (Grid<bool> g, int x, int y) => false);
        stringGrid = new Grid<StringGridObject>(20, 10, 8f, this.transform.position, (Grid<StringGridObject> g, int x, int y) => new StringGridObject(g, x, y));
